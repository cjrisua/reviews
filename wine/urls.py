...
urlpatterns = [
    ...
    path(r'inventory/terroir/', views.TerroirListView.as_view(), name='terroir_list'),
    path(r'inventory/terroir/<int:pk>/', views.TerroirListView.as_view(), name='terroir_list_parent'),
    path(r'inventory/terroir/<slug:country>/', views.TerroirListView.as_view(), name='inventory_terroir_filter_c'),
    path(r'inventory/terroir/<int:pk>/update/', views.TerroirUpdateView.as_view(), name='inventory_terroir_update'),
    ...
    #path(r'inventory/terroir/<int:pk>/update/', views.TerroirUpdateView.as_view(), name='inventory_terroir_update'),
    #path(r'inventory/terroir/<int:pk>/', views.TerroirListViewSet.as_view(), name='inventory_terroir_filter'),
    #path(r'inventory/terroir/<slug:country>/', views.TerroirListViewSet.as_view(), name='inventory_terroir_filter_c'),
