...
urlpatterns = [
    ...
    path(r'inventory/producer/add/', views.ProducerCreateView.as_view(success_url=reverse_lazy('wine:producer_list')), name='inventory_producer_add'),
    ...
    path(r'inventory/wine/<int:pk>/', views.WineDetailListView.as_view(), name='wine_detail'),
